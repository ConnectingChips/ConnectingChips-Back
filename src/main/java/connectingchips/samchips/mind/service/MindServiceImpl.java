...
import connectingchips.samchips.joinedmind.service.JoinedMindServiceImpl;
...
public class MindServiceImpl implements MindService{
    ...
    JoinedMindServiceImpl joinedMindServiceImpl;


    @Override
    public FindMindOutput findMind(long mindId) {
        return FindMindOutput
                .of(findVerifiedMind(mindId), joinedMindServiceImpl.countJoinedMindUser(mindId));
    ...
    public List<FindMindOutput> findMinds() {
        return mindRepository.findAll()
                .stream()
                .map(a -> FindMindOutput.of(a, joinedMindServiceImpl.countJoinedMindUser(a.getMindId())))
                .toList();
    }
